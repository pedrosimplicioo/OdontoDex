...
const INITIAL_DATA = {
  ...
  procedures:{
    ...
    d3:[{id:"trocar-rest",label:"Restauração de Rotina",free:true}],
    d4:[{id:"dessensibilizante",label:"Dessensibilizante",free:true},{id:"recessao-gengival",label:"Sensibilidade por Recessão",free:true},{id:"ajuste-oclusal-pos-rest",label:"Ajuste Oclusal pós-restauração",free:true}],
    ...
    e1:[{id:"endo-urgencia",label:"Urgência Endodôntica",free:true}],
  ...
  protocols:{
    ...
    "recessao-gengival":{title:"Sensibilidade por Recessão Gengival",time:"30 min",level:"médio",free:true,steps:["Classificar recessão: Miller I/II (recuperável) ou III/IV (parcial/sem recuperação)","Identificar causa: bruxismo, escovação agressiva, doença periodontal","Eliminar fator causador antes de qualquer tratamento","Recessão leve com sensibilidade → dessensibilizante + verniz de flúor 5%","Recessão com exposição dentinária extensa → restauração cervical em resina (Classe V)","Recessão Miller I/II com indicação estética ou funcional → encaminhar periodontia para enxerto gengival","Orientar: escova macia, técnica de Bass modificada, gel de flúor noturno"],errors:["Restaurar sem eliminar a causa — recessão progride","Indicar enxerto sem controle do fator etiológico","Ignorar Miller III/IV — expectativa irreal do paciente"],decisions:[{if:"Miller I/II + sensibilidade leve",then:"Dessensibilizante + flúor"},{if:"Miller I/II + queixa estética",then:"Enxerto gengival (encaminhar periodontia)"},{if:"Exposição dentinária extensa",then:"Restauração Classe V em resina"},{if:"Miller III/IV",then:"Cobertura parcial possível — alinhar expectativa com paciente"}],panic:[{problem:"Paciente com múltiplas recessões",solution:"Investigar bruxismo + encaminhar periodontia"}],crises:[]},
    "ajuste-oclusal-pos-rest":{title:"Ajuste Oclusal pós-restauração",time:"15 min",level:"fácil",free:true,steps:["Confirmar que a sensibilidade iniciou após restauração recente","Papel carbono fino (8µm) em máxima intercuspidação","Identificar ponto alto na restauração","Desgaste seletivo com broca multilaminada esférica","Checar em lateralidade e protrusão","Polir a área desgastada com borracha abrasiva","Reavaliar em 7 dias"],errors:["Não usar papel carbono — desgaste às cegas","Desgastar sem polir — área rugosa acumula placa","Ignorar lateralidade — ponto alto em excursão é causa frequente"],decisions:[{if:"Sensibilidade persiste após ajuste",then:"Dessensibilizante + reavaliação em 14 dias"},{if:"Dor espontânea ou ao frio por >30s",then:"Suspeitar pulpite irreversível — endodontia"}],panic:[{problem:"Desgastou demais a restauração",solution:"Restauração direta para recompor"}],crises:[]},
...
const QUICK_CONDUCT_CARDS = {
  "coroa-caiu": {
    ...
    subtitle: "Veja se dá para recimentar ou se precisa refazer.",
    synonyms: [
  ...
  "pino-nucleo-soltou": {
    ...
    subtitle: "Entenda quando reaproveitar e quando reconstruir.",
    synonyms: [
  ...
  "coroa-nao-entra-card": {
    ...
    subtitle: "Localize onde trava antes de ajustar ou cimentar.",
    synonyms: [
  ...
  "porcelana-lascou": {
    ...
    icon: '<i class="ti ti-dental-broken"></i>',
    subtitle: "Decida entre polir, reparar, laboratório ou nova peça.",
    synonyms: [
  ...
  "dente-pouca-estrutura": {
    ...
    subtitle: "Avalie reconstrução, pino/núcleo, coroa ou prognóstico.",
    synonyms: [
  ...
  "protese-total-machuca": {
    ...
    subtitle: "Separe ponto de pressão, borda, oclusão e adaptação.",
    synonyms: [
  ...
  "protese-total-caindo": {
    ...
    subtitle: "Veja se é adaptação, selado, borda, oclusão ou nova prótese.",
    synonyms: [
  ...
  "ppr-machuca-balanca": {
    ...
    icon: '<i class="ti ti-dental-broken"></i>',
    subtitle: "Separe sela, grampos, apoios, oclusão e dentes pilares.",
    synonyms: [
  ...
  "dente-protese-soltou-card": {
    ...
    subtitle: "Veja quando reparar na cadeira e quando enviar ao laboratório.",
    synonyms: [
  ...
  "protese-quebrou-card": {
    ...
    subtitle: "Identifique o que quebrou e envie com as referências certas.",
    synonyms: [
